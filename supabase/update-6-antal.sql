-- ============================================================
-- SPIIS – opdatering 6: "få tilbage"-antal, der låser og tæller ned
-- Kør ÉN gang i Supabase → SQL Editor → Run.
-- (Erstatter opdatering 5 – det er fint at køre denne, uanset om
--  opdatering 5 er kørt eller ej.)
--
-- Skriver chefen fx "3 tilbage" på en ret, kan kunderne højst
-- bestille 3 – og tallet tæller selv ned for hver bestilling.
-- Rammer det 0, markeres retten automatisk som UDSOLGT.
-- Alt sker under lås i databasen, så to samtidige kunder aldrig
-- kan snyde systemet. Udsolgte retter afvises som hidtil.
-- ============================================================
