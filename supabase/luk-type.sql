-- ============================================================
-- LUK TAKE-AWAY ELLER SPIS-HER HVER FOR SIG
-- Kør ÉN gang i Supabase -> SQL Editor -> Run.
--
-- Hvorfor: nogle dage kan koekkenet godt lave mad ud af huset, men
-- ikke daekke borde - eller omvendt. Foer kunne man kun lukke HELE
-- dagen, og saa mistede man ogsaa den halvdel der sagtens kunne lade
-- sig goere.
--
-- Efter denne opdatering afviser DATABASEN selv en bestilling af en
-- lukket type - ogsaa hvis nogen proever udenom hjemmesiden.
...
-- Baeltet OG selerne: uanset hvordan en raekke proever at komme ind,
-- afvises den, hvis den type er lukket den dag.
...
select 'Take-away og spis-her kan nu lukkes hver for sig. '
    || 'Saet det i admin -> Kalender -> tryk paa dagen.' as besked;
