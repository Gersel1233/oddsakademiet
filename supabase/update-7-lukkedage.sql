-- ============================================================
-- SPIIS – opdatering 7: arrangement-dage lukker for bestillinger
-- Kør ÉN gang i Supabase → SQL Editor → Run.
-- (Indeholder ALT fra opdatering 5 og 6 – kør bare denne éne,
--  uanset hvilke af de andre du har nået at køre.)
--
-- Dage med et aftalt arrangement – og dage chefen selv har lukket –
-- tager ikke imod almindelige madbestillinger. Derudover: udsolgt-
-- markeringer afvises, og "få tilbage"-antal låser og tæller ned.
-- ============================================================
